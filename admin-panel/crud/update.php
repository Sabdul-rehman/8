...
if(isset($_POST['submit'])){
    ...
    $phone = mysqli_real_escape_string($conn, $_POST['phone']);
      ...
      $insertquery =  "UPDATE user SET name ='$name', email ='$email', adress ='$adress',phone='$phone' WHERE id = $id";
		...
		<div class="modal-content">
			<form method="POST" action="">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						<label>Address</label>
						<input type="text" name="adress" class="form-control" value="<?php echo $result['adress']; ?>" required>
					</div>
					<div class="form-group">
						<label>Phone</label>
